...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        //     eventEmitted = true
        // })
        supplyChain.Harvested().on('data', event => {
            eventEmitted = true
        })
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        supplyChain.Processed().on('data', event => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        supplyChain.Packed().on('data', event => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        supplyChain.ForSale().on('data', event => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        supplyChain.Sold().on('data', event => {
            eventEmitted = true;
        });
        ...
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Invalid item Distributor ID')
        assert.equal(eventEmitted, true, 'Invalid event emitted')  
    })    
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        supplyChain.Shipped().on('data', event => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        supplyChain.Received().on('data', event => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        supplyChain.Purchased().on('data', event => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC')
        //assert.equal(resultBufferOne[2], ownerID, 'Error: Invalid item State')
